    ...
    <div class="space-y-10">
        ...
        >
            ...
            <div class="flex gap-3">
                <button
                    class="px-4 py-2 bg-white border border-slate-200 text-slate-700 rounded-xl font-bold text-sm hover:bg-slate-50 transition-all"
                >
                    Exporter (.csv)
                </button>
                <button
                    class="px-4 py-2 bg-indigo-600 text-white rounded-xl font-bold text-sm hover:bg-indigo-700 shadow-lg shadow-indigo-200 transition-all"
                >
                    + Nouvelle Campagne
                </button>
            </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div
                class="xl:col-span-2 bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden"
            >
                <div
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            >
                                <td class="px-6 py-4 flex items-center gap-3">
                                    ...
                                    <div
                                        class="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center font-bold text-[10px] text-indigo-700"
                                    >
                                        {{
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="px-3 py-1 bg-slate-100 text-slate-600 rounded-lg text-[11px] font-bold"
                                    >
            ...
            <div class="space-y-6">
                <div
                    class="bg-slate-900 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden group"
                >
                    <i
                        class="pi pi-bolt absolute -right-4 -bottom-4 text-8xl text-white/5 rotate-12 group-hover:rotate-0 transition-transform duration-500"
                    ></i>
                    <h4 class="font-bold text-lg mb-2">Besoin d'aide ?</h4>
                    <p class="text-slate-400 text-sm mb-4 leading-relaxed">
                        Consultez la documentation pour gérer les exports de
                        plannings.
                    </p>
                    <button
                        class="w-full py-2 bg-indigo-500 hover:bg-indigo-400 text-white rounded-xl text-sm font-bold transition-colors"
                    >
                        Ouvrir le guide
                    </button>
                </div>
                ...
                >
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            <h4
                                class="font-bold text-slate-800 mb-4 text-sm flex items-center gap-2"
                            >
                            ...
                            <div class="space-y-6">
                                ...
                                <div
                                    v-if="
                                        ...
                                        0
                                    "
                                    v-for="notif in $page.props.auth.notifications.slice(
                                        0,
                                        4,
                                    )"
                                    :key="notif.id"
                                ...
                                >
                                    ...
                                    <div class="flex-1">
                                        <p
                                            class="text-xs text-slate-700 font-medium leading-snug group-hover:text-indigo-600 transition-colors"
                                        >
                                            {{ notif.data.message }}
                                        </p>
                                        <!-- Formatage de la date (ex: "Il y a 2 heures" ou Date locale) -->
                                        <p
                                            class="text-[10px] text-slate-400 mt-1 flex items-center"
                                        >
                                            <i
                            ...
                            <div class="mt-6 pt-4 border-t border-slate-50">
                                <Link
                                    href="/notifications"
                                    class="text-[10px] font-black text-indigo-500 hover:text-indigo-700 uppercase tracking-tighter"
                                >
